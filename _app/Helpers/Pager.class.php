...
class Pager {
    ...
    private function getSyntax() {
        ...
        if ($this->Rows > $this->Limit){
            ...
            $this->Paginator .= "<li class=\"page-item\"><a class=\"page-link\" href=\"{$this->Link}1\" aria-label=\"Previous\"><span aria-hidden=\"true\">Primeira</span></a></li>";
    
            for ($i = ($this->Page - $MaxLinks); $i <= ($this->Page - 1); $i++){
                if($i >= 1){
                    $this->Paginator .= "<li class=\"page-item\"><a class=\"page-link\" href=\"{$this->Link}{$i}\">{$i}</a></li>";
                    //$this->Paginador .= "<li><a title=\"Página {$i}\"  href=\"{$this->Link}{$i}\">{$i}</a></li>";
                }
            }
            
            $this->Paginator .= "<li class=\"page-item active\"><a class=\"page-link\" href=\"#\">{$this->Page}<span class=\"sr-only\">(current)</span></a></li>";
            //$this->Paginador .= "<li class=\"page-item active\">{$this->Pagina}</li>";
            
            for ($j = ($this->Page + 1); $j <= ($this->Page + $MaxLinks); $j++){
                if($j <= $Paginas){
                    
                    $this->Paginator .= "<li class=\"page-item\"><a class=\"page-link\" href=\"{$this->Link}{$j}\">{$j}</a></li>";
                }
            }            
            $this->Paginator .=  "<li class=\"page-item\"><a class=\"page-link\" href=\"{$this->Link}{$Paginas}\" aria-label=\"Next\"><span aria-hidden=\"true\">Última</span></a></li>";
            //$this->Paginador .= "<li><a href=\"{$this->Link}{$Paginas}\">{$this->Ultimo}</a></li>";
