                ...
                <table class="table table-striped" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{$row.Nome}</td>
                            <td>{$row.NomeCurso}</td>
                            <td>{$row.AnoIngresso}</td>
                            <td>{$row.AnoFormacao}</td>
                            <td class="actions text-center">
                                <a class="btn btn-warning btn-xs" data-toggle="modal" data-target="#upd_novo_cadastro_modal" 
                                    onclick="loadEgressoCursoEAFUpdModal({$row.idAluno}, {$row.idCurso}, '{$row.AnoIngresso}', '{$row.AnoFormacao}')">Editar</a>
                            </td>
                        </tr>
                    {/foreach}
                    </tbody>
...
{include file="view/egressoCursoEAFAddModal.tpl"}
{include file="view/egressoCursoEAFUpdModal.tpl"}
